@echo off
set include=F:\VCSoft\Soft\MASM\Winasm\Release\masm\bin615\include;%include%
set lib=F:\VCSoft\Soft\MASM\Winasm\Release\masm\bin615\lib;%lib%
set path=F:\VCSoft\Soft\MASM\Winasm\Release\masm\bin615\bin;%path%
